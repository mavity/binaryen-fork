...
| :--- | :--- | :--- | :--- |
| `remove_unused_module_elements.rs` | [RemoveUnusedModuleElements.cpp](../../../src/passes/RemoveUnusedModuleElements.cpp) | **40%** | Removes defined functions/globals; simplifies by skipping unused imports and table-referenced elements. |
| `remove_unused_brs.rs` | [RemoveUnusedBrs.cpp](../../../src/passes/RemoveUnusedBrs.cpp) | **30%** | Implements basic CFG pruning; lacks advanced branch-to-next-instruction threading and label-merging logic. |
| `remove_unused_names.rs` | [RemoveUnusedNames.cpp](../../../src/passes/RemoveUnusedNames.cpp) | **5%** | **Skeleton**: Basic trait implementation; does not yet perform comprehensive cross-module name pruning. |
| `remove_imports.rs` | [RemoveImports.cpp](../../../src/passes/RemoveImports.cpp) | **5%** | **Stub**: Empty pass implementation; logic for tracking and purging unnecessary imports is completely missing. |
| `remove_memory_init.rs` | [RemoveMemoryInit.cpp](../../../src/passes/RemoveMemoryInit.cpp) | **5%** | **Stub**: Skeleton for initialization pruning; does not yet implement identifying redundant segments. |
| `vacuum.rs` | [Vacuum.cpp](../../../src/passes/Vacuum.cpp) | **40%** | Successfully removes nops and dead blocks via `EffectAnalyzer`; missing recursive depth after simplification. |
| `simplify_identity.rs` | [SimplifyIdentity.cpp](../../../src/passes/SimplifyIdentity.cpp) | **30%** | Basic identities (x+0, x*1) implemented; missing commutativity, bitwise tricks, and float-specific identities. |
