...
| `remove_imports.rs` | [RemoveImports.cpp](../../../src/passes/RemoveImports.cpp) | **90%** | Tracks import usage and replaces calls with side-effect-aware placeholders. |
| `remove_memory_init.rs` | [RemoveMemoryInit.cpp](../../../src/passes/RemoveMemoryInit.cpp) | **30%** | **Basic**: Clears data segments and start functions; missing fine-grained redundancy analysis. |
...
| `simplify_identity.rs` | [SimplifyIdentity.cpp](../../../src/passes/SimplifyIdentity.cpp) | **85%** | Extensive identities for integer arithmetic and bitwise ops. |
