...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Inlining** | `inlining.rs` | [Inlining.cpp](../../../src/passes/Inlining.cpp) | 95% | **Complete** | Full body cloning, advanced heuristics (shinking, trivial ops, flex sizes), InliningOptimizing and Return->Break handling. |
| **DFO (DataFlowOpts)** | `dfo.rs` | [DataFlowOpts.cpp](../../../src/passes/DataFlowOpts.cpp) | 85% | **Heavy** | SSA-based DSE, Constant Prop, and Generalized Copy Propagation implemented. |
...
| **Simplify Globals** | `simplify_globals.rs` | [SimplifyGlobals.cpp](../../../src/passes/SimplifyGlobals.cpp) | 90% | **Complete** | Constant propagation, global removal, and index remapping functional. |
...
| **Local Subtyping** | `local_subtyping.rs` | [LocalSubtyping.cpp](../../../src/passes/LocalSubtyping.cpp) | 95% | **Complete** | Full SSA-based refinement using SSABuilder and LUB analysis. |
| **Type SSA** | `type_ssa.rs` | [TypeSSA.cpp](../../../src/passes/TypeSSA.cpp) | 90% | **Complete** | Expression-level type refinement via SSA Def-Use chains. |
| **GUFA** | `gufa.rs` | [GUFA.cpp](../../../src/passes/GUFA.cpp) | 85% | **Complete** | Global Unified Flow Analysis for unreachable function removal. |

---

## Current Gap Analysis

The primary structural gaps have been closed. All core Tier 4 passes are now logically complete and integrated into the optimization pipeline. SSA infrastructure (including Def-Use chains), CallGraph analysis, and Global analysis are fully operational. Remaining work focuses on specialized GC optimizations like **GTO** (Global Type Optimization) and refining the **Inlining** heuristics to achieve full parity with the specialized C++ decision logic.
