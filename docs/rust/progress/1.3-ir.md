...
-   [x] **Implement `Signature`**: Add support for parameter and result types.
-   [x] **Implement `HeapType`**: Basic structure for GC types.
-   [x] **Implement Ordering**: Implement `PartialOrd`/`Ord` for types to support canonicalization.
-   [x] **Tests**: Unit tests for equality, printing, and serialization.
