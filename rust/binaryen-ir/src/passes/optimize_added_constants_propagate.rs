...
pub struct OptimizeAddedConstantsPropagate;

impl Pass for OptimizeAddedConstantsPropagate {
    fn name(&self) -> &str {
        "OptimizeAddedConstantsPropagateDASHED"
    }
...
mod tests {
    ...
    #[test]
    fn test_optimize_added_constants_propagate() {
        let bump = Bump::new();
        ...
        let mut pass = OptimizeAddedConstantsPropagate;
        pass.run(&mut module);
